...
@Component({
  selector: 'app-widget-dialog-ask-english',
  template: `
...
export class WidgetDialogAskEnglishComponent {
  ...
  constructor(private crudService: CrudService,
    private messageService: MessageService,) {
      crudService.collectionName =  this.collection;
  }
 ...
 */
  confirmCustom() {
    ...
    if (this.uid != '' && this.uid != undefined) {
        this.crudService.delete(this.uid);
        this.loading = false;
